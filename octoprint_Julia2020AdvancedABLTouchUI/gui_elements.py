...
class MainUiClass(QtGui.QMainWindow, mainGUI_advanced_abl.Ui_MainWindow):
    ...
    def updateTemperature(self, temperature):
        ...
        self.tool0ActualTemperature.setText(str(int(temperature['tool0Actual'])))  # + chr(176)
        ...
        self.bedActualTemperatute.setText(str(int(temperature['bedActual'])))  # + chr(176))
        self.bedTargetTemperature.setText(str(int(temperature['bedTarget'])))  # + chr(176))
